    ...
    >
      <div className="border-b border-gray-100 px-5 py-4">
        ...
        <p className="mt-1 text-sm text-gray-500">
          How your facilities appear on your public listing and in search filters.
        </p>
      </div>
      ...
      <div className="p-5">
        {selectedCount === 0 ? (
          <div className="rounded-xl border border-dashed border-gray-200 bg-gray-50/60 px-4 py-8 text-center">
            <p className="text-sm font-medium text-gray-700">No amenities yet</p>
            <p className="mt-1 text-sm text-gray-500">
              Add equipment and services on the left — they&apos;ll show up here as guests browse your
              listing.
            </p>
          </div>
        ) : (
