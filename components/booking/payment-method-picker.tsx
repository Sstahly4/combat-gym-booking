...
function PaymentMethodOption({
  ...
  return (
    ...
    >
      <div className="pointer-events-none flex h-5 w-11 shrink-0 items-center justify-start text-gray-900">
        {icon}
      </div>
  ...
  return (
    ...
    >
      <PaymentMethodOption
        ...
        icon={
          <span className="inline-flex h-5 w-[2.75rem] items-center justify-start">
