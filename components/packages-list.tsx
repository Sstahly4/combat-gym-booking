...
import { Check, BedDouble, ChevronLeft, ChevronRight, Home, Wifi, Car, Droplets, UtensilsCrossed, Users, Shield, Clock, Building2, Dumbbell, Thermometer, Waves } from 'lucide-react'
          ...
          {sortedPackages.map(pkg => {
            ...
            const priceInfo = (isValidDuration && !shouldShowPerSession)
              ...
              : {
                  ...
                  durationLabel: pkg.type === 'training' ? '1 session' : ''
                }
      ...
      <Dialog open={variantsModalOpen} onOpenChange={setVariantsModalOpen}>
        <DialogContent className="max-w-5xl max-h-[90vh] overflow-hidden flex flex-col">
          <DialogHeader className="pb-4 border-b">
            <DialogTitle className="text-2xl font-semibold text-gray-900">{activePackage?.name}</DialogTitle>
