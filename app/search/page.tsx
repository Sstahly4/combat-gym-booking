...
function parseSearchQuery(query: string): { location: string; discipline: string } {
  ...
  for (const disc of DISCIPLINES) {
    ...
    if (queryLower.includes(discLower)) { foundDiscipline = disc; break }
    if (discLower === 'bjj' && (queryLower.includes('jiu jitsu') || queryLower.includes('jiujitsu'))) { foundDiscipline = disc; break }
    if (discLower === 'muay thai' && (queryLower.includes('muaythai') || queryLower.includes('muay'))) { foundDiscipline = disc; break }
  }
  let location = query
