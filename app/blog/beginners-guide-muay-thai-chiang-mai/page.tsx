...
const DESCRIPTION =
  'Start Muay Thai in Chiang Mai without getting injured, ripped off, or overwhelmed. Gyms, weekly routine, cost, recovery, and what beginners experience on a first trip.'
...
const FAQ_ITEMS = [
  {
    ...
    a: 'No. Most Chiang Mai camps run daily beginner-friendly classes that start with stance, basic strikes, and pad combinations. You do not need prior experience. Show up on time and follow the coaches.',
  },
  {
  ...
  },
  {
    ...
    a: 'Wraps, mouthguard, loose training shorts, a good water bottle, and blister/tape basics. Many travelers buy gloves and shin guards locally. That reduces luggage and lets coaches fit you properly.',
  },
  {
...
export default function BeginnersGuideChiangMaiPage() {
  ...
  return (
    <ArticleShell
      title={TITLE}
      subtitle="You do not need to be fit, flexible, or fearless to start Muay Thai in Chiang Mai. You need a plan. This guide covers it."
      breadcrumbs={[
    ...
    >
      ...
      <GuideHero
        ...
        priority
        overlayText="Chiang Mai suits first-time Muay Thai students: slower pace, cooler mornings, and camps that work with complete beginners every day."
      />
      ...
      <GuideLeadRow
        ...
        statValue="2–4 wk"
        statDescription="The stay length where a total beginner sees technique change without overtraining."
      ...
      <section id="why-cm" className="mb-14 scroll-mt-24">
        ...
        <div className="prose prose-gray max-w-none space-y-4 text-base leading-relaxed text-gray-800 md:prose-lg">
          <p>
            If you have never thrown a punch in your life, Chiang Mai is one of the best training destinations in the world to learn Muay Thai. Bangkok and Phuket get more fight-night attention. For a <strong>first-time beginner</strong>, Chiang Mai is usually the smarter choice.
          </p>
          <p>
          ...
          <p>
            Mornings stay cool enough (especially November through February) for roadwork without overheating. That helps when you are new to training and still adjusting to Thailand&rsquo;s heat.
          </p>
        </div>
      </section>
      ...
      <GuideSection variant="slate" className="mb-14">
        <div className="grid gap-8 md:grid-cols-2 md:items-center">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-bold text-gray-900 md:text-3xl">What &ldquo;beginner&rdquo; means at Chiang Mai gyms</h2>
            <div className="mt-3 space-y-3 text-base leading-relaxed text-gray-700">
              ...
              <p>
                What you should expect: shin bruises, tight hips, heavy legs, and deep fatigue from hitting pads in 32&deg;C humidity.
              </p>
            </div>
          </div>
          <figure className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
            ...
            <figcaption className="px-4 py-3 text-xs text-gray-600">
              Cool mornings make roadwork workable for complete beginners, especially in high season.
            </figcaption>
          </figure>
        </div>
      </GuideSection>
      ...
      <section id="week-by-week" className="mb-14 scroll-mt-24">
        ...
        <p className="mb-8 max-w-3xl text-gray-600">
          This is the progression most beginners need: one session per day at first, not a twice-a-day fighter schedule from day one.
        </p>

        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            <p className="text-xs font-semibold uppercase tracking-wider text-[#003580]">Week 1</p>
            <h3 className="mt-1 text-lg font-semibold text-gray-900">Adaptation: one session per day</h3>
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <ul className="mt-3 space-y-2 text-sm leading-relaxed text-gray-700">
              ...
              <li>Optional: one two-a-day on a day you feel fresh. Never do two-a-days two days in a row.</li>
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <ul className="mt-3 space-y-2 text-sm leading-relaxed text-gray-700">
              <li>Cut new combos. Drill the same 3&ndash;4 combinations for hundreds of reps.</li>
      ...
      <GuideSection id="routine" variant="slate" className="mb-14">
        ...
        <p className="mb-6 max-w-3xl text-gray-700">
          This is roughly what your day looks like once you are settled. Most long-stay beginners who finish their trips follow a similar rhythm.
        </p>
        <GuideThreeCards
          items={[
            {
              title: 'Morning (optional)',
              body: '6:30 to 7:30am: light 3&ndash;5km run or shadowboxing. Skip if you trained hard the day before. Breakfast: eggs, fruit, rice or oats. Drink plenty of water.',
            },
            {
              title: 'Afternoon (main session)',
              body: '3:30 to 5:30pm: warm-up, shadow, pad rounds, bag work, technique, light clinch. Most of your learning happens here because coaches are fresh.',
            },
            {
              title: 'Evening',
              body: 'Walk or stretch, eat a proper meal with protein and rice, hydrate, and get to bed by 10pm. Sleep matters more than late nights when you train daily.',
            },
          ]}
        />
      </GuideSection>
      ...
      <section id="gyms" className="mb-14 scroll-mt-24">
        <GuideAccentIntro icon={Compass} title="How to pick a beginner-friendly Chiang Mai gym" subtitle="What matters on day one" />
        <div className="prose prose-gray max-w-none space-y-4 text-base leading-relaxed text-gray-800 md:prose-lg">
          <p>
            Do not over-optimize. The difference between the &ldquo;best&rdquo; Chiang Mai gym and the third best is negligible if you are a beginner. What matters: <strong>coach-to-student ratio</strong>, <strong>a clearly scheduled beginner block</strong>, <strong>a location you can commute to every day without resenting it</strong>, and <strong>accommodation where you can sleep</strong>.
          </p>
          <p>
            The biggest predictor of beginner success in Chiang Mai is a short commute. You need to still show up on day 14 when you are tired and sore.
          </p>
          <p>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {[
            ...
            },
            {
              ...
              body: 'Nightlife cuts into sleep and recovery. If you drink most evenings, your training volume and technique will suffer.',
            },
            {
            ...
            },
            {
              ...
              body: 'Coaches adjust pad work to your level, but only if they know your level. Tell them on day one that you are new.',
            },
          ].map((item) => (
      ...
      <GuideSection variant="amber" className="mb-14">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-3 text-sm leading-relaxed text-gray-800">
              If you are thinking long-term, read the <Link href="/blog/thailand-training-visa-dtv" className="font-medium text-[#003580] underline">Thailand training visa / DTV guide</Link> before you book. How long you can legally stay affects how hard you should train in week one.
            </p>
          </div>
        </div>
      </GuideSection>
