...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/blog/best-muay-thai-gyms-krabi' },
...
export default async function BestMuayThaiGymsKrabiPage() {
  ...
  const articleLd = {
    ...
    headline: TITLE,
    description: DESCRIPTION,
    mainEntityOfPage: absoluteUrl('/blog/best-muay-thai-gyms-krabi'),
  ...
  return (
    ...
    >
      ...
      <GuideHero
        imageSrc="https://images.unsplash.com/photo-1549973890-38b8d7b51b2a?auto=format&fit=crop&w=1400&q=80"
