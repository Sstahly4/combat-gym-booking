...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/blog/best-muay-thai-gyms-hua-hin' },
...
export default async function BestMuayThaiGymsHuaHinPage() {
  ...
  const articleLd = {
    ...
    headline: TITLE,
    description: DESCRIPTION,
    mainEntityOfPage: absoluteUrl('/blog/best-muay-thai-gyms-hua-hin'),
  ...
  return (
    ...
    >
      ...
      <GuideHero
        imageSrc="https://images.unsplash.com/photo-1526481280695-3c687fd5432c?auto=format&fit=crop&w=1400&q=80"
