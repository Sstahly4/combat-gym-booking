...
import type { FaqCategorySlug } from '@/lib/help/faq-categories'
  ...
  },
  {
    ...
    answer: (
      <ol className="list-decimal space-y-2 pl-5 text-sm leading-relaxed text-gray-700">
        ...
        <li>
          Tell us through{' '}
          <Link href="/contact" className={FAQ_INLINE_LINK}>
            Customer service
          </Link>{' '}
      ...
      <div className="space-y-5 text-gray-700">
        <div>
          ...
          <div className="grid gap-2 sm:grid-cols-3">
            <Link href="/bookings" className={FAQ_JUMP_TILE}>
            ...
            <Link href="/saved" className={FAQ_JUMP_TILE}>
            ...
            <Link href="/contact" className={FAQ_JUMP_TILE}>
  ...
  },
  {
    ...
    answer: (
      <p className="text-sm leading-relaxed text-gray-700">
        ...
        <Link href="/bookings" className={FAQ_INLINE_LINK}>
          Manage your booking
        </Link>{' '}
        or message{' '}
        <Link href="/contact" className={FAQ_INLINE_LINK}>
    ...
    answer: (
      <div className="space-y-4 text-gray-700">
        ...
        <p className="text-sm leading-relaxed">
          ...
          <Link href="#faq-booking-nav" className={FAQ_INLINE_LINK}>
  ...
  // Safety & Security (extra)
  {
    ...
    answer: (
      <p className="text-sm leading-relaxed text-gray-700">
        ...
        <Link href="/data-deletion" className={FAQ_INLINE_LINK}>
          data deletion instructions
        </Link>{' '}
        or{' '}
        <Link href="/contact?intent=data-deletion" className={FAQ_INLINE_LINK}>
          submit a deletion request
        </Link>
        . Full detail:{' '}
        <Link href="/privacy" className={FAQ_INLINE_LINK}>
          Privacy policy
        </Link>
        .
      </p>
...
export const HELP_CENTER_FAQS: HelpCenterFaqItem[] = faqs
